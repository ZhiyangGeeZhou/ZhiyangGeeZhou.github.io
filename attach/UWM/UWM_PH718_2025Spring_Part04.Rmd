...
Overlay multiple histograms by a categorical variable.
...
starwars %>% 
  ...
  # theme(axis.text.x = element_text(angle = 45, hjust = 1)) # alternatively change the angle of text
```
...
reflecting the covariation between categorical variables.
...
Showing relationships between two continous variables.
