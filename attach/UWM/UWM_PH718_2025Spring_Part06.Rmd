...
plotly::plot_ly(
  ...
  geo = list(
    projection = list(type = "orthographic"), "natural earth" or "orthographic"
    showland = TRUE
  ),
...
### Interactive geographic map: hightlighting states in US
...
plotly::plot_ly(
  ...
  locationmode = "ISO-3",
  z = c(1,2,3),  # c(1,2,3): means one color for each country
...
### Interactive geographic map: hightlighting Wisconsin on a USA Map
...
plotly::plot_ly(
  ...
  z = c(1,1),  # c(1,1): means one color for all
