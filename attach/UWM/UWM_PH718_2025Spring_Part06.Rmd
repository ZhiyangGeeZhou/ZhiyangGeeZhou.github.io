...
ui <- fluidPage(
  theme = bs_theme(
    ...
    base_font = font_google("Special Gothic Expanded One"), # available fonts at https://fonts.google.com
...
- Still a bit sticking: depends on intended audience, required computing power, number of expected users, ...
...
- Sign Up at https://www.shinyapps.io with your email or GitHub account.
  
- Install `rsconnect` package locally.
...
choose shinyapps.io as the server and follow prompts.
  - Go to your shinyapps.io account and copy the name, token and secret for authentication. 

- `R` will upload your app and provide a public URL like 
https://yourname.shinyapps.io/shiny_app_name/